...
--
-- Dumping data for table `players_names`
--

LOCK TABLES `players_names` WRITE;
/*!40000 ALTER TABLE `players_names` DISABLE KEYS */;
INSERT INTO `players_names` VALUES (1,'Ronaldo'),(2,'Nani');
/*!40000 ALTER TABLE `players_names` ENABLE KEYS */;
UNLOCK TABLES;
